...
const Home = () => {
  ...
  const [countedProposal, setCountedProposal] = useState(0);
  ...
  useEffect(() => {
    if (isInitialized) {
      async function getProposals() {
        ...
        setProposals(table);
        setTotalProposal(results.length);
      }

      async function getPassedRate() {
        const ProposalCounts = Moralis.Object.extend("ProposalCounts");
        const query = new Moralis.Query(ProposalCounts);
        const results = await query.find();
        let votesUp = 0;
        ...
        setCountedProposal(results.length);
      ...
      const fetchTokenIdOwners = async () => {
        const options = {
          ...
          token_id:
            "10767527961072460609707326236249391169159199720874440232410320380703363039247",
          chain: "mumbai",
        };
            ...
            {proposals && (
              <div className="tabContent">
                ...
                <div className="widgets">
                  ...
                  >
                    <Widget info={totalProposal} title="Proposals Created">
                  ...
                  >
                    <Widget
                      info={totalProposal - countedProposal}
